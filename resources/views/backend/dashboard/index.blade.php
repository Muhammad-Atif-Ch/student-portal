                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15">Free Users</h5>
                                            <h2 class="mb-3 font-18">{{ $membership->android_free + $membership->ios_free }}</h2>
                        ...
                        <div class="card-statistic-4">
                            <div class="align-items-center justify-content-between">
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            <h5 class="font-15"> Paid Users</h5>
                                            <h2 class="mb-3 font-18">{{ $membership->android_premium + $membership->ios_premium }}</h2>
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                        <div class="card-content">
                                            ...
                                            <h2 class="mb-3 font-18">$ {{ round($revenue, 2) }}</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0 table-md">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Language</th>
                                            <th>Total User Use</th>
                                        </tr>
                                    </thead>
                                    <tbody class="language-usage-report">
                                    </tbody>
                                </table>
                            </div>
                        </div>
