...
$(window).on("load", function () {
    ...
    // Check if theme settings have been loaded
    if ($("#main-content").is(":visible")) {
        $(".loader").fadeOut("slow");
    } else {
        // If theme is not yet loaded, wait until settings API fetch is complete
        let checkThemeLoaded = setInterval(function () {
            if ($("#main-content").is(":visible")) {
                $(".loader").fadeOut("slow");
                clearInterval(checkThemeLoaded);
            }
